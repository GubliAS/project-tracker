        ...
        <div class="box main-dashboard-banner project-dashboard-banner overflow-hidden">
          <div class="box-body p-[1.5rem]">
            <div class="grid grid-cols-12 gap-x-6 justify-between">
              ...
              >
                <img alt="Projects illustration" class="img-fluid" src="/assets/img/media-85.png" />
              </div>
            </div>
          </div>
        </div>
                ...
                <tbody class="top-selling">
                    ...
                    <td>
                      <div class="flex">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img alt="" class="" src="/assets/img/2.jpg" />
                        </span>
                  ...
                  <tr class="border-b !border-defaultborder dark:!border-defaultborder/10">
                    <td>
                      <div class="flex">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img alt="" class="" src="/assets/img/3.jpg" />
                        </span>
                        <div class="flex-1 ms-2">
                  ...
                  <tr class="border-b !border-defaultborder dark:!border-defaultborder/10">
                    <td>
                      <div class="flex">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img alt="" class="" src="/assets/img/21.jpg" />
                        </span>
                        <div class="flex-1 ms-2">
                  ...
                  <tr class="border-b !border-defaultborder dark:!border-defaultborder/10">
                    <td>
                      <div class="flex">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img alt="" class="" src="/assets/img/4.jpg" />
                        </span>
                        <div class="flex-1 ms-2">
                  ...
                  <tr class="border-b !border-defaultborder dark:!border-defaultborder/10">
                    <td class="border-b-0">
                      <div class="flex">
                        <span class="avatar avatar-sm avatar-rounded">
                          <img alt="" class="" src="/assets/img/11.jpg" />
                        </span>
                        <div class="flex-1 ms-2">
              ...
              <div class="flex items-start gap-4 mb-3">
                ...
                <div class="flex-shrink-0 text-end ms-auto">
                  ...
                  <div class="avatar-list-stacked">
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/11.jpg" />
                    </span>
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/2.jpg" />
                    </span>
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/5.jpg" />
                    </span>
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/6.jpg" />
                    </span>
                  </div>
                </div>
              </div>
              ...
              <div class="flex items-start gap-4 mb-3">
                ...
                <div class="flex-shrink-0 text-end ms-auto">
                  ...
                  <div class="avatar-list-stacked">
                    ...
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/8.jpg" />
                    </span>
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/2.jpg" />
                    </span>
            ...
            <div>
              <div class="flex items-start gap-4 mb-3">
                ...
                <div class="flex-shrink-0 text-end ms-auto">
                  ...
                  <div class="avatar-list-stacked">
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/15.jpg" />
                    </span>
                    <span class="avatar avatar-sm avatar-rounded">
                      <img alt="img" src="/assets/img/3.jpg" />
                    </span>
                      ...
                      <div class="box-body">
                        ...
                        <div class="flex flex-wrap gap-2 items-center">
                          ...
                          <div class="avatar-list-stacked ms-auto">
                            ...
                            <span class="avatar avatar-xs avatar-rounded">
                              <img alt="img" src="/assets/img/12.jpg" />
                            </span>
                            <span class="avatar avatar-xs avatar-rounded">
                              <img alt="img" src="/assets/img/8.jpg" />
                            </span>
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="avatar-list-stacked">
                        ...
                        <span class="avatar avatar-xs avatar-rounded">
                          <img alt="img" src="/assets/img/4.jpg" />
                        </span>
                        <span class="avatar avatar-xs avatar-rounded">
                          <img alt="img" src="/assets/img/6.jpg" />
                        </span>
                        <span class="avatar avatar-xs avatar-rounded">
                          <img alt="img" src="/assets/img/7.jpg" />
                        </span>
                      </div>
                    </td>
                    <td>
